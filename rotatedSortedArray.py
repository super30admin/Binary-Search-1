...
Method 2: In sorted rotated arrays, One of the array halves or sub-array will always be sorted. Half is wrt to the mid
value.
1. Find mid
...
class Solution:
    def search(self, nums: List[int], target: int) -> int:
        ...
        while low <= high:
            ...
            elif nums[low] <= nums[mid]:  # edge case: [3,1]

...
'''
1. First calculate mid value and check if its equal to target. Then check if the middle value is greater or less than the right value to check which side the element lies
